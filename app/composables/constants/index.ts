...
export const roadmap = [
  {
    ...
    name: 'Nuxt & Vue',
    description:
      'Погружение в Nuxt 4 с Composition API, auto-imports и оптимизацией производительности. Изучение best practices для масштабируемых приложений.'
  },
  {
    icon: 'material-icon-theme:folder-element-open',
    name: 'Vuex & Pinia',
    description:
      'Изучить решения для управления состоянием, а так же как альтернативу Jotai/Recoil '
  },
  {
    icon: 'material-icon-theme:gulp',
    name: 'Gulp',
    description:
      'Освоить автоматизацию сборки для оптимизации workflow: минификация, конкатенация файлов, препроцессинг и деплой проектов'
  }
]
